...
// ----------------------------------------------------------
// SERIALIZAR DOM → dados_colono.js
// ----------------------------------------------------------

// IDs de checkboxes de controle interno que não são itens de conteúdo
...
function serializarSecao(containerId) {
  ...
  container.querySelectorAll(':scope > .item').forEach(div => {
    ...
    if (!nome) return;
    // Decodifica entidades HTML do atributo value
...
// ----------------------------------------------------------
// SALVAR DADOS — exporta dados_colono.js atualizado
// ----------------------------------------------------------
